...
int main() {
    ...
    else if (mode == 2) verifyFunc = [](const vector<int>& arr) { return isSortedSample(arr, 500); };
    else if (mode == 3) verifyFunc = isSortedOddIndex;
    else if (mode == 4) verifyFunc = isSortedEvenIndex;
    else if (mode == 5) verifyFunc = [](const vector<int>& arr) { return isSortedHeadTailSample(arr, 500); };
    else if (mode == 6) verifyFunc = [](const vector<int>& arr) { return isSortedMiddleSample(arr, 500); };
    else {
